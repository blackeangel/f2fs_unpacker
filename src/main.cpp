...
static void usage(const char* prog)
{
    fprintf(stderr,
        ...
        "  file_contexts.txt  SELinux labels (only entries with a label)\n"
        "  f2fs_special.txt   F2FS-specific attributes:\n"
        "                     compression (algo/cluster/saved_blocks/released),\n"
        "                     encryption, inline_data, inline_dents, pinned\n"
        "\n"
        "Example:\n"
